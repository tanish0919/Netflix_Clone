  ...
  return (
    <>
        ...
        <div className='relative flex items-center group'>
            ...
            <div id={'slider'} className='w-full h-full relative overflow-y-auto whitespace-nowrap scroll-smooth scrollbar-hide'>
                ...
                {movies.map( (item,id) => (
                    ...
                    <div className='absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white'>
                        <p className='text-xs md:text-sm text-bold flex justify-center text-center items-center h-full'>
                            {item?.title}
                        </p>
